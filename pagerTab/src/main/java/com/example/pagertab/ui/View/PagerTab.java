package com.example.pagertab.ui.View;
...
import com.example.pagertab.R;
import com.example.pagertab.ui.Utils.UIUtils;
import com.example.pagertab.ui.activity.BaseActivity;
...
public class PagerTab extends ViewGroup {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.i("tag","raw: "+mIndicatorColor+":"+(height-mIndicatorHeight)+":"+(mIndicatorLeft+mIndicatorWidth)+":"+height+":"+mIndicatorPaint);
